...
run() {
    ...
    figure_dir=${exp_dir}/
    R CMD BATCH --no-save --no-restore "'--args chd_path=\"${input_CHD_path}\" asd_path=\"${input_ASD_path}\" control_path=\"${input_Control_path}\" output_dir=\"${figure_dir}\"'" plot_figure_s.R
}

run config_residual_block_8.json  res/residual_block_8
