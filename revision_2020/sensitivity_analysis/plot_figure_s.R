...
plotComparison <- function(x, y, zz, output_dir, method="", genes="All") {
	...
	output = paste(output_dir, "/case-vs-control_", method, "_", genes, ".separate.pdf", sep="")
...
plotComparison( chd$MVP_rank, autism$MVP_rank,  controls$MVP_rank, output_dir, "MVP", "All" )
