...
python prioritize_all.py --input_config all_HIS_SNV.json --model_dir v2_HIS/model/ --input_prefix all_snv/sample_HIS_SNV --output_dir all_snv

python prioritize_all.py --input_config all_HS_SNV.json --model_dir v2_HS/model/ --input_prefix all_snv/sample_HS_SNV --output_dir all_snv
